...
- **What to build?** → [prd.md](docs/prd.md)
- **How does it work?** → [architecture-spine.md](docs/architecture-spine.md)
- **Implementation details?** → [architecture-detailed.md](docs/architecture-detailed.md)
- **Using BMAD-METHOD?** → [BMAD-project.md](docs/BMAD-project.md)
...
**Skill installation**: CLI fetches `skills-registry.json` from CDN → downloads skill files (batched, 10 concurrent) to `~/.cache/agent-skills/` → installs via copy or symlink to agent-specific directory → records in `.agents/.skill-lock.json` (v2, Zod-validated, atomic writes).
...
Using **BMAD-METHOD** in this project?

→ Read [docs/BMAD-project.md](docs/BMAD-project.md) for patterns, checklists, and examples specific to Agent Skills.

---

**Last Updated:** 2026-06-25  
**Version:** 2.0 (consolidated)  
**See Also:** [SECURITY.md](SECURITY.md) for security policy, [docs/INDEX.md](docs/INDEX.md) for full documentation index
